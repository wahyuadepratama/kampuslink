		...
		<div class="tiket row">
			...
			<div class="body col-lg-9">
				...
				<div class="supp">
					<div class="suppx">
						<p>Support : </p>
						<img src="{!!asset('client/img/logo.png')!!}" width="50">
					</div>
					<div class="suppxx">
						<span>kampuslink.com</span>
					</div>
				</div>
			</div>
			<div class="qr col-lg-3">
				<img src="{!!asset('client/img/clients-logo/qr-kode.png')!!}" width="200">
				<p>Check in untuk acara ini<br>Pindai kode QR ini di acara untuk check in</p>
			</div>
		</div>
	</div>
</section>
